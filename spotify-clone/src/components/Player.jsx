  ...
  return (
    <>
      <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
        ...
        <img className="w-4 cursor-pointer" src={assets.shuffle_icon} alt="image"/>
        <img className="w-4 cursor-pointer" src={assets.prev_icon} alt="image"/>
        <img className="w-4 cursor-pointer" src={assets.play_icon} alt="image"/>
        <img className="w-4 cursor-pointer" src={assets.next_icon} alt="image"/>
        <img className="w-4 cursor-pointer" src={assets.loop_icon} alt="image"/>
        </div>
