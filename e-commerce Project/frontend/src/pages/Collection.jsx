...
setCategory(prev => [...prev,e.target.value])
  ...
  const sortProducts =()=>{
    ...
    let filcopy = filterProducts.slice()

    switch (sortType) {
      case 'low-high':
        setFilterProducts(filcopy.sort((a,b)=>(a.price - b.price)))
        break;

        case 'high-low':
          setFilterProducts(filcopy.sort((a,b)=>(b.price - a.price)))
          break
...
sortProducts()
  ...
  return (
    ...
    <p className='flex gap-2'>
      <input type="checkbox" className='w-3' onChange={toggleSubCategory} value={'Winterwear'} /> Winterweaar
    </p>
    </div>
    </div>
    </div>
